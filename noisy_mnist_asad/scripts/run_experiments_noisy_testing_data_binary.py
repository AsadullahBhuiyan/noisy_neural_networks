...
from src.nnet_models import build_model, evaluate, compute_loss
...
def main() -> None:
    ...
    pdf_path = os.path.join("results", "figures", f"noisy_test_summary_{cache_key}{suffix_tag}.pdf")
    ...
    append_runtime_log(
        runtime_log_path,
        {
            ...
            "script": "run_experiments_noisy_testing_data_binary.py",
            "cache_key": cache_key,
            "output_dir": output_dir,
