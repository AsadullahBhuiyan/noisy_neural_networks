...
def _validate_infimnist_data_dir(infimnist_module) -> str:
    ...
    if missing:
        raise FileNotFoundError(
            ...
            "'rm -f noisy_mnist/infimnist_py/data && ln -s /home/abhuiyan/nnet_error_project/noisy_mnist/data/MNIST/raw noisy_mnist/infimnist_py/data'."
        )
    return data_dir
...
def get_dataloaders(
    ...
    if dataset_name == "mnist":
        def _safe_to_tensor(img) -> torch.Tensor:
            ...
            return torch.clamp(x * brightness_scale, 0.0, 1.0)
