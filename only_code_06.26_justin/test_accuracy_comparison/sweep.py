...
# ws11 gets kmnist
# ws12: cuda:0 gets fashion_mnist
# ws12: cuda:1 gets mnist

DATASETS = ["kmnist"]
TRAIN_SIZES = [4_000]
IMG_HWS = [(28, 28)]
NOISE_TYPES = ["replacement"]
# NOISE_PROBABILITIES = [0.85, 0.86, 0.87, 0.88, 0.89, 0.90, 0.91, 0.92, 0.93, 0.94, 0.95, 0.96, 0.97, 0.98, 0.99, 1.0]
