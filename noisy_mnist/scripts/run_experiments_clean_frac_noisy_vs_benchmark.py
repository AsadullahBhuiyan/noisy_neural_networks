...
def main() -> None:
    ...
    plot_path_png_base = os.path.join("results", "figures", f"comparison_grid_{cache_key}{suffix_tag}.png")
    plot_path_pdf = os.path.join("results", "figures", f"comparison_grid_{cache_key}{suffix_tag}.pdf")
