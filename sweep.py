...
NUM_NOISE_DATASETS_PER_COMBO = 100
NUM_MODELS_PER_NOISE_DATASET = 50
NUM_MODELS_PER_COMBO = NUM_NOISE_DATASETS_PER_COMBO * NUM_MODELS_PER_NOISE_DATASET
SEED = 22334
NUM_CLASSES = 10

# ws09: cuda:0 gets mnist additive_gaussian
# ws09: cuda:1 gets mnist replacement
# ws11: cuda:0 gets fashion_mnist additive_gaussian
# ws11: cuda:1 gets fashion_mnist replacement
# ws12: cuda:0 gets kmnist additive_gaussian
# ws12: cuda:1 gets kmnist replacement

DATASETS = ["kmnist"]
TRAIN_SIZES = [4_000]
IMG_HWS = [(28, 28)]
NOISE_TYPES = ["replacement"]
